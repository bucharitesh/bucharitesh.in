...
export const SubmitBookmarkForm = memo(({ className, setFormOpen, bookmarks, currentBookmark } : { className?: string, setFormOpen: (open: boolean) => void, bookmarks: any[], currentBookmark: any }) => {
  const memoizedFormOptions: any = useMemo(
    () => ({
